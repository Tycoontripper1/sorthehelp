...
export function Ledger({ v }: { v: SorthehelpVals }) {
  return (
    <div>
      <div
        style={css(
            ...
            <div style={css("display:flex;flex-direction:column;gap:14px")}>
              ...
              <div>
                ...
                <input
                  type="email"
                  value={v.newEmail}
                  onChange={(e) => v.setNewEmail(e.target.value)}
              ...
              <button
                ...
                onClick={v.openBulk}
                style={css(
                  "display:block;width:100%;margin-top:12px;border:none;background:none;font-family:Inter,sans-serif;font-size:12.5px;color:#8C4A3A;text-decoration:underline;cursor:pointer",
                )}
              >
                Adding a group? Paste a list of members instead
              </button>
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div style={css("display:flex;flex-direction:column;gap:14px")}>
              <div>
                ...
                >
                  Plan for everyone on this list
                </label>
                <div style={css("display:flex;flex-wrap:wrap;gap:8px")}>
                  {v.newMemberPlans.map((p, i) => (
                    <button
              ...
              {v.newPlanIsCustom && (
                ...
                >
                  ...
                  <div style={css("display:flex;gap:6px;align-items:flex-end")}>
                    <button
                      type="button"
                      onClick={() => v.pickType("one_time")}
                      style={css(
                        `flex:1;border:2px solid ${v.newType === "one_time" ? "#202A33" : "#D6C69A"};background:${v.newType === "one_time" ? "#202A33" : "transparent"};color:${v.newType === "one_time" ? "#EFE7D3" : "#202A33"};border-radius:4px;padding:10px 4px;font-size:11.5px;font-weight:600;cursor:pointer;font-family:Inter,sans-serif`,
                      )}
                    >
                      One-time
                    </button>
                    <button
                      ...
                      onClick={() => v.pickType("recurring")}
                      style={css(
                        `flex:1;border:2px solid ${v.newType === "recurring" ? "#202A33" : "#D6C69A"};background:${v.newType === "recurring" ? "#202A33" : "transparent"};color:${v.newType === "recurring" ? "#EFE7D3" : "#202A33"};border-radius:4px;padding:10px 4px;font-size:11.5px;font-weight:600;cursor:pointer;font-family:Inter,sans-serif`,
                      )}
                    >
                      Recurring
                    </button>
              ...
              <div>
                ...
                >
                  One member per line — name, phone, email
                </label>
                <textarea
                  value={v.bulkText}
                  onChange={(e) => v.setBulkText(e.target.value)}
                  placeholder={
                    "Ngozi Okafor, 08034112288, ngozi@example.com\nTolu Bankole, 07051186620"
                  }
                  rows={6}
                  style={css(
                    "width:100%;box-sizing:border-box;border:1px solid #D6C69A;background:#FBF7EC;border-radius:4px;padding:11px;font-family:'IBM Plex Mono',monospace;font-size:14px;line-height:1.6;color:#202A33;outline:none;resize:vertical",
                  )}
                />
                <div
                  style={css(
                    "font-size:11.5px;color:#9c9484;margin-top:6px",
                  )}
                >
                  Phone and email are optional — just a name on its own line
                  still works. {v.bulkCount} member
                  {v.bulkCount === 1 ? "" : "s"} ready to add.
                </div>
              </div>
              <div style={css("display:flex;gap:8px")}>
                <button
